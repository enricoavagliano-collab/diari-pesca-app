...
import { Target, Fish, Worm, Package, MapPin, BookOpen } from "lucide-react";
import { ARTICOLI, TAGS, Tag } from "@/lib/articoli";

const TAG_STYLES: Record<Tag, { Icon: typeof Target; bg: string }> = {
  Tecnica: { Icon: Target, bg: "#2CA6A4" },
  Specie: { Icon: Fish, bg: "#5B9BD5" },
  Esche: { Icon: Worm, bg: "#C97B4A" },
  Attrezzatura: { Icon: Package, bg: "#8FA8B2" },
  Spot: { Icon: MapPin, bg: "#7CB342" },
  Diario: { Icon: BookOpen, bg: "#FF9A3C" },
};
