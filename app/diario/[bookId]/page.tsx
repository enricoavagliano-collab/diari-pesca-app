...
const PDF_FOLDERS: Record<string, { link: string; topics: string[] }> = {
  feeder: {
    ...
    topics: ["Pasturatori feeder", "Pasture feeder", "Lettura del fiume", "Feeder fishing"],
  },
  "mare-e-foce": {
    link: "https://drive.google.com/drive/folders/1Q2wTAyLYlg0hmYlo9l-H-1ZRWANmzS5a",
    topics: ["Dove il Tevere si insala", "Metodo bolognese", "Pesca dalla scogliera", "Come leggere la corrente in foce"],
  },
};
