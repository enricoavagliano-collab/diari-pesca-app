...
echo "=== Aggiungo il campo Note a Le mie lenze / assetti ==="
...
echo ""
echo "Novita': nel form 'Le mie' (sia Mare/Foce che Feeder), sotto i campi"
echo "tecnici, c'e' ora un'area di testo dedicata alle Note. Le lenze gia'"
echo "salvate in precedenza restano intatte, semplicemente senza nota"
echo "(possono essere modificate per aggiungerla)."
echo ""
echo "Ricorda: bash note-mie-lenze.sh, poi:"
echo "git add -A && git commit -m 'aggiunge campo note a le mie lenze e assetti' && git push"
