...
const TAG_STYLES: Record<Tag, { Icon: typeof Fish; bg: string }> = {
  Tecnica: { Icon: Fish, bg: "#2CA6A4" },
  Specie: { Icon: Fish, bg: "#5B9BD5" },
  Esche: { Icon: Fish, bg: "#C97B4A" },
  Attrezzatura: { Icon: Package, bg: "#8FA8B2" },
  Spot: { Icon: Fish, bg: "#7CB342" },
  Diario: { Icon: Fish, bg: "#FF9A3C" },
};
